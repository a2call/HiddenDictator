 ...
 * Generated at: 2016-02-22 21:38:43 UTC
...
import ch.dnisler.hiddendictator.Status;
...
public final class util_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("ch.dnisler.hiddendictator.Status");
    ...
    try {
      ...
      out.write("\t");
		...
		if (request.getParameter("username") != null) {
			...
			session.setAttribute("status", "inlobby");
			Server.getUser(session.getAttribute("user").toString()).setStatus("inlobby");
